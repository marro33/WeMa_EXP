...
const std::string images_path_detect{ "/Users/Grenouille/Code/MyXcodeProject/opencvtest/testdata/recognization/" };
...
int test_face_detect_LBP()
{
	...
	const std::string lbp_files_path{ "/Users/Grenouille/Code/MyXcodeProject/opencvtest/testdata/lbpcascades/" };
